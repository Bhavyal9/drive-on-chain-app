    ...
    <>
      <div className="bg-img">
        <div className="select-destination">
          ...
          <div>
            <label htmlFor="drop-location" className="label">
              Drop Location
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="drop-date" className="label">
              Drop Date
            </label>
            <input
              type="date"
          ...
          <div>
            <label htmlFor="drop-time" className="label">
              Drop Time
            </label>
            <input
              type="time"
          ...
          <button className="get-car-btn" onClick={() => storeData()}>
            Find Car
          </button>
        </div>
      </div>
